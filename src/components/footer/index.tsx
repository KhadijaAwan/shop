...
import { catalogue, details, moreItems, locationItems } from "@/theory";
import {
  Flex,
  Box,
  Text,
    ...
    >
      <Flex alignItems="center" width="100%" justifyContent="center">
        <Flex
          ...
          justifyItems="center"
        >
          <Flex direction="column" width="100%" justifyContent="center" mb={{base:"10", lg:"0"}}>
            <HStack>
              <Stack width="100%">
                <Heading mb={3} size="md" color="gray.50">
                  Catalogue
                </Heading>
                {catalogue.map((c: any) => (
      ...
      <Flex alignItems="center" direction="column">
        <Box height="1px" width={{base:"96%", lg:"90%"}} bg="gray.500" my={6}></Box>
